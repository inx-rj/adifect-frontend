...
export const MemberCompanyDeleteReducer = (state = {}, action) => {
  switch (action.type) {
...
export const agencyCompanyUpdateEditReducer = (state = {}, action) => {
  switch (action.type) {
    case AGENCY_COMPANY_EDIT_UPDATE_REQUEST:
      return { loading: true };

    case AGENCY_COMPANY_EDIT_UPDATE_SUCCESS:
      return { loading: false, success: true };

    case AGENCY_COMPANY_EDIT_UPDATE_FAIL:
      return { loading: false, error: action.payload };
