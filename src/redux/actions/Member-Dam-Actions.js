import {
  ...
  MEMBER_DAM_Newest_REQUEST,
  MEMBER_DAM_Newest_SUCCESS,
  MEMBER_DAM_Newest_FAIL,
...
export const listAllDam = (id, agencyid , companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const listAllRootImages = (id ,companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const listAllCollectionDAM = (id,companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const listAllROOTDam = (id,companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const listAllDamImages = (id,companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const CollectionView = (id, agencyid,companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const DamSearch = (id, agencyid,companyidinhouse,parentid) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const DamSearchfolder = (id, agencyid,companyidinhouse,parentid) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const DamFilterFavourate = (id,companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const DamFilterFavourateCount = (id,companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const listCompanies = (agencyid,params) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const listCompaniesID = (id, agencyid,params) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const CountCompanies = (id, agencyid,companyidinhouse) => async (dispatch, getState) => {
  try {
    dispatch({
    ...
    if (userData?.user?.user_level == 4) {
      data = await api.get(
       ...
       data = await api.get(
        `${BACKEND_API_URL}members/member-dam-filter/count?company=${id}&user_id=${agencyid}`,
        config
      );
    }
...
export const CountCompaniesID =
  (parentid, id, agencyid) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await api.get(
        `${BACKEND_API_URL}members/member-dam-filter/count?id=${parentid}&company=${id}&agency=${agencyid}`,
        config
      );
  ...
  export const InhouseDamCollectionSearch = (params,id) => async (dispatch, getState) => {
    try {
      dispatch({
