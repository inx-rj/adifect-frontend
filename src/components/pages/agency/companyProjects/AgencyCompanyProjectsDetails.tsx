  ...
  return (
    <div className="page-container">
      ...
      <div className="page-card card p-0">
        {companyProjectsList.data.results?.filter((e) => e.id == communityId)
          ?.length > 0 &&
          companyProjectsList.data.results
            ?.filter((e) => e.id == communityId)
            ?.map((item) => (
              <Box
                        ...
                        <Grid xs={12} mt={2}>
                          ...
                          >
                            {formateISODateToLocaleString(
                              item.story_metadata.published_at
                            ) ?? ""}
                          </Typography>
                        </Grid>
                        <Grid xs={12} mt={1}>
                          ...
                          >
                            {formateISODateToLocaleString(
                              item.story_metadata.updated_at
                            ) ?? ""}
                          </Typography>
                        </Grid>
                      </Grid>
