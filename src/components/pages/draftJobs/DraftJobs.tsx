...
import {
  DELETE_DRAFT_JOBS_LIST,
  GET_DRAFT_JOBS_LIST,
} from "redux/actions/draftJobs/draftJobs.action";
...
const DraftJobs = () => {
  ...
  useEffect(() => {
    ...
    dispatch(GET_DRAFT_JOBS_LIST(paginationData, headerCompany));
  }, [success, headerCompany, paginationData]);
