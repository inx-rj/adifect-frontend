...
export default function Job_edit_dev_Aman() {
  ...
  const validateSubmit = (e) => {
    ...
    const tempErrors = {
      ...
      jobDocuments: validations.jobDocuments(jobDocuments),
                        ...
                        <p className="job-documents-img mt-3 f-16" key={index}>
                          {fileExtension[index]?.match(
                            ...
                            <>
                              ...
                              // onClick={(e) =>
                              //   downloadFile(
                              //     `{${BACKEND_API_URL}media/job_images/${fileNameDisplay[index]}}`,
                              ...
                              <div
                                className="overlay"
                                onClick={() => removeDocument(index, "data")}
                              >
                                <a href="#" className="icon" title="Remove">
                                  <i className="fa-solid fa-circle-xmark"></i>
                                </a>
