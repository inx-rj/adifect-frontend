  ...
  const submitHandler = async (data, event) => {
    ...
    if (updateProposal) {
      ...
      const success = await axios
        .put(`${BACKEND_API_URL}job-applied/${jobAppliedId}/`, formData, config)
        .then((res) => {
          swal({
                ...
                {availableJobList?.map((item, index) => (
                  <div className="agencyjoblistdiv agencyjoblistdivhi">
                    ...
                    >
                      <div className="bt-Title">
                        ...
                        <div className="jopapplycreator">
                          <>
                            ...
                            {/* -- BACKUP -- {item?.job_applied_status == "True" ? (
                      ...
                      <div className="jobListDetailsAreaAndTaskbox jobListDetailsAreaAndTaskbox1">
                  ...
                  <div className="Marketingcamaign">
                    ...
                    <div className="mediaimg Providedmediaimg">
                      ...
                      {jobvideoDocuments?.map((item, index) => (
                        <div className="agencyjobimguploaddiv popupdivshowdatapopup" key={index}>
                  ...
                  <>
                              ...
                              {datepricewarning && (
                                <>
                                  ...
                                  <p className="proposingtext colorsec proposingtext1">
                                    You’re proposing a price over {printPreData}
                                    % higher. Consider proposing a closer due
                                    date.
                                  </p>
                                </>
                              )}
                    ...
                    <div className="applyJobImgAttach">
                      ...
                      <p className="attachfilesCreatorText">
                        You may attach up to 10 files under the size of 10MB
                        ...
                        >
                          ...
                          <p>
                            <img
                              ...
                              src={
                                process.env.PUBLIC_URL + "/img/uploadimg.png"
                              }
                              alt=""
                            />
                            Attach Files
