...
import Creator_profile_feedback from "./Creator-profile-feedback";
import Creator_profile_account_setting from "./Creator-profile-account-setting";
...
const Creator_profile = () => {
  ...
  const submitHandler = async (e) => {
    ...
    for (const key of Object.keys(selectedPortfolio)) {
      formData.append(
        "portfolio",
        selectedPortfolio && selectedPortfolio[key].id
          ? selectedPortfolio[key].id
                    ...
                    <div className="jobsFourInProgress">
                      <div className="OnejobsFourInProgress">
                        <h5 className="oneEightJobs">
                          {getCreatorProfileJobs?.Total_Job_count ?? "0"}
                          <br />
                      ...
                      <div className="TwojobsFourInProgress">
                        <h5 className="oneEightJobs">
                          {getCreatorProfileJobs?.In_progress_jobs ?? "0"}
                          <br />
                ...
                <div className="feedbackAboutAreaMainD">
                  <Box sx={{ width: "100%" }}>
                    <TabContext value={value}>
                              ...
                              <div className="portfolioImgContentHeadDiv">
                                {portfolioDetails?.length > 0 &&
                                  portfolioDetails?.map((portfolio_item, i) => (
                                    <>
                                      <div className="portfolioImgContent portfoliocreatorpage">
                                        <div
                                          key={i}
                      ...
                      <TabPanel value="2">
                        <Creator_profile_feedback />
                      </TabPanel>
                      <TabPanel value="3">
                        <Creator_profile_account_setting />
                      </TabPanel>
                    </TabContext>
                  </Box>
                </div>
