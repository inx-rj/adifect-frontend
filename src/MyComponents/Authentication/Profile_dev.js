...
export default function Profile() {
  ...
  const [profile_status_display, setProfileStatusDisplay] = useState("1");
  ...
  useEffect(() => {
    ...
    if (
      ...
      setPortfolio(user.portfolio);
      setProfileStatus(user.profile_status);
      setProfileStatusDisplay(user.profile_status);
      // setAvailability(user.availability);
  ...
  //     // setProficiency(user.proficiency);
  //   }
  // }, [successDetails, dispatch, successUpdate]);
  // // }, [successDetails, successRefresh, dispatch, user]);
  ...
  const submitHandler = async (e) => {
    ...
    formData.append("profile_status", profile_status_display);
                  ...
                  <div>
                    ...
                    >
                      <div className="profileinp">
                        ...
                        <Select
                          className={
                            profile_status_display === "null"
                              ? "selectinputcolor"
                              : "menuiteminputcolor"
                          }
                          value={profile_status_display}
                          open={isOpenStatus}
                          onOpen={() => {
                          ...
                          onChange={(e) => {
                            ...
                            setProfileStatusDisplay(e.target.value);
                          }}
                          displayEmpty
            ...
            >
              ...
              <div className="dialogcontent_and_actions">
                <DialogContent className="portfolio_content">
                  ...
                  {/* Textfield */}
                  {/* <div>
                  <h5 className="form-label  mt-2" for="email">
                    Languages known
                  </h5>
                  <input
                    type="text"
                  ...
                  {/* Select */}
                  {/* <div>
                    <h5 for="proficiency">Proficiency</h5>
                    <Select
                          ...
                          {URL.createObjectURL(item) && (
                            <div className="port-single" key={index}>
                              ...
                              <span
                                ...
                                className="overlayasdasd"
                                onClick={() =>
                                  removePortfolioImage(index, "new")
                                }
                              >
                                <a
                                  href="#"
