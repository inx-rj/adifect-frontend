...
export default function Invite() {
  ...
  // console.log("successInvite", successInvite);
          ...
          <div style={{ display: "flex" }}>
            ...
            <div style={{ display: "flex" }}>
              ...
              <Button
                ...
                title="delete"
                className="deletebutt invitebtnnew"
              >
                Delete
              </Button>
  ...
  useEffect(() => {
    ...
    dispatch({ type: COMPANY_INVITE_PROFILE_POST_RESET });
    ...
    <>
      {isLoading ? (
        ...
        <>
          ...
          <div className="Topallpage AllPageHight Custompage Custompageinvite invitepagenew ">
            <div className="ContentDiv Categoriesdiv1 inviteDraftTable">
              <div className="Status"></div>
              <div className="savebtn Categorybtn inviteuserbt">
                <button
