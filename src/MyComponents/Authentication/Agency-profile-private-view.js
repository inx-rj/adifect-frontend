...
import Agency_profile_feedback from "./Agency-profile-feedback";
...
const Agency_profile_private_view = () => {
  ...
  const goToPrevPage = (prevpage) => {
    ...
    navigate(`/agency-profile-private-view?${urlParams}`);
  };
  ...
  useEffect(() => {
    dispatch(defaultPageLoader());
    dispatch(listAgencyJobs(currentPage));
  }, [success, currentPage]);
  ...
  const handleSaveSkillSet = (evt) => {
    const tempErrors = {
      skillset: !skillset && "Please select a skillset",
      rating: !rating && "Please select a rating",
    };
    setOpen6(false);
    setskillsetErrors(tempErrors);
          ...
          <div className="inlineprivateProfileContent">
            <div className="privateProfileContent">
              ...
              <div className="privateProfileName">
                ...
                <p>I’m a graphic designer based in sunny Arizona, USA!</p>
                  ...
                  <TabPanel value="1">
                    <div className="allContenOfPrivateAbout">
                      ...
                      <div className="ParaGraphAboutMePrivateAbout">
                        <div className="paragraph-pAbout">
                          ...
                          {!user?.profile_description ? (
                            ...
                            <>
                              {/* <p id="Profilediv">{profile_description.substring(0, 300) + "..."}</p>
                      <button id="fadeINBTN" type="button">
                        Read more
                      </button> */}
                      ...
                      <div className="skillContentPublicPr">
                        <div className="showHideEditiconWithTitle">
                          <h3 className="skillsPublicPrivate">Skills</h3>
                          {showIcon && (
                            <div className="editIconShowOrHideD">
                              {" "}
                              <img
                            ...
                            <DialogActions>
                              <div className="sharebuttonjobcontent">
                                <div className="cancelButtonnewWithSave">
                                  ...
                                  <button
                                    // onClick={(e) =>
                                    //   handleEditSkillSet(e, editSkillsetId)
                                    // }
                        ...
                        <div className="profileskills">
                          ...
                          {openSkillset && (
                            <div className="skill-Box">
                              <div className="skillname skillprofilepage">
                                <h4>Skill Name</h4>
                                <Autocomplete
                                  value={skillset}
                                  options={skillsData.filter(
                                ...
                                <span
                                  style={{
                                    color: "#D14F4F",
                                    opacity: skillseterrors.skillset ? 1 : 0,
                                  }}
                                >
                                  {skillseterrors.skillset ?? "valid"}
                                </span>
                              </div>
                              <div className="skillname rating-field">
                                <h4>Rating</h4>
                                <input
                                ...
                                <span
                                  style={{
                                    color: "#D14F4F",
                                    opacity: skillseterrors.rating ? 1 : 0,
                                  }}
                                >
                                  {skillseterrors.rating ?? "valid"}
                                </span>
                              </div>
                              <div className="RadingProfile">
                                <label>
                                  <h4>Rating</h4>
                                </label>
                                <div className="RadingStar">
                              ...
                              <div className="AWokflowButton-p">
                                <button
                                  onClick={handleOpenRatingBox}
                                  className="Work-C-Btt-P"
                                >
                                  Cancel
                                </button>
                                <button
                                  className="Save-C-Btt-P"
                                  onClick={handleSaveSkillSet}
                                >
                                  Saves
                                </button>
                            ...
                            <div className="skill-Box">
                              <div className="skillname skillprofilepage">
                                ...
                                <Autocomplete
                                  ...
                                  onChange={(e, value) => {
                                    setskillsetEditErrors({
                                      ...errors,
                                      skillset: null,
                                    });
                                    skillsetEditChangeHandler(e, value);
                                  }}
                                  disablePortal
                                  id="combo-box-demo"
                                  sx={{ width: 300 }}
                                ...
                                <span
                                  style={{
                                    color: "#D14F4F",
                                    opacity: skillsetEditerrors.skillset
                                      ? 1
                                      : 0,
                                  }}
                                >
                                  {skillsetEditerrors.skillset ?? "valid"}
                                </span>
                              </div>
                         
                              <div className="AWokflowButton-p">
                                <button
                                  onClick={() => skillsetEditCloseHandler()}
                                  className="Work-C-Btt-P"
                                >
                                  Cancel
                                </button>
                        ...
                        <div className="todaySkillsDF">
                          {skillsData?.map((item) => (
                            <div className="RadingProfiles">
                              ...
                              {/* 
                            <div className="RadingStar">
                              {((Math.round(item?.skill_rating * 2) / 2) % 1 !=
                                0) !=
                                0 && (
                               ...
                               <span>
                                <img
                                  ...
                                  src="/img/editicon.png"
                                  alt=""
                                  onClick={() => editSkillsetHandler(item.id)}
                                />
                                <img
                                  className="editicon"
                                  src="/img/delet.png"
                                  alt=""
                                  onClick={() => deleteSkillsetHandler(item.id)}
                                />
                              </span> 
                            </div> */}
                            </div>
                      ...
                      <div className="porfolioContentPublicPr">
                        <div className="showHideEditiconWithTitle">
                          ...
                          {showIcon && (
                            <span className="editIconShowOrHideD">
                              {" "}
                              <img
                              ...
                              <DialogContent className="portfolio_content">
                                ...
                                >
                                  ...
                                  <img
                                    className="mr-2"
                                    src={
                                      process.env.PUBLIC_URL + "/img/upload.png"
                                    }
                                    alt=""
                                  />
                                  Attach Files
                                    ...
                                    portfolio?.map((item, index) => (
                                      <div className="port-single" key={index}>
                                        ...
                                        <span
                                          ...
                                          onClick={() => {
                                            removePortfolioImage(index, "data");
                                            removePortfolioImageByID(item?.id);
                                          }}
                                        >
                                          <a
                                            href="#"
                        ...
                        {/* <div className="portfolioImgContent">
                          <div className="firstportfolioImgContent">
                            <img src="/img/manhgrr.png" alt="" />
                            <p>LookingIntoSky.jpeg</p>
                          </div>
                          <div className="firstportfolioImgContent">
                            <img src="/img/manhgrr.png" alt="" />
                            <p>LookingIntoSky 2.jpeg</p>
                          </div>
                          <div className="firstportfolioImgContent">
                            <img src="/img/manhgrr.png" alt="" />
                            <p>Looking Into Sky</p>
                          </div>
                          <div className="firstportfolioImgContent">
                            <img src="/img/manhgrr.png" alt="" />
                            <p>LookingIntoSky 3.jpeg</p>
                          </div>
                        </div> */}
                      </div>
                      {/* <div className="paginationPublicprivate">
                        <MDBDataTable
                          paging={true}
                          searching={false}
                          entries={false}
                        ...
                        <Pagination>
                          ...
                          {[...Array(pages).keys()].map((x) => (
                            <>
                              <LinkContainer
                                key={x + 1}
                                to={`/agency-profile-private-view?page=${
                                  x + 1
                                }`}
...
export default Agency_profile_private_view;
