...
import { DAM_ID_RESET } from "../../constants/Dam-constant";
...
function Media(currentFolder) {
    ...
    <div style={thumb} key={file.name}>
      <div style={thumbInner}>
        ...
        {file.type == "video/mp4" && (
          <>
            <div onClick={removeFile(file)}>
              <span className="crossicon12">X5</span>
            </div>
        ...
        {file.type == "audio/mpeg" && (
          <>
            <div onClick={removeFile(file)}>
              <span className="crossicon">X3</span>
            </div>
            <audio controls>
        ...
        {file.type != "video/mp4" && (
          <>
            <div onClick={removeFile(file)}>
              <span className="crossicon">X1</span>
            </div>
            <img
              src={file.preview}
              style={img}
  ...
  }, [moveon, deleteloader, deleteCollectionloader]);
  ...
  const handleFileSubmit = () => {
    ...
    for (let index = 0; index < files.length; index++) {
      ...
      formData.append("agency", userDataFromStore.user?.user_id);
  ...
  useEffect(() => {
    ...
    dispatch(listAllRootImages());
    dispatch(listAllCollectionDAM());
  }, [getdatawhere, deleteloader, deleteCollectionloader]);
  ...
  }, [deleteCollectionloader, deleteloader]);
  ...
  const deleteimage = () => {
    ...
    if (count.length > 0) {
      ...
      // formData.append(deletevaluesingle);
      if (deleteicontext) {
        swal({
          title: "",
                          ...
                          <div className="container">
                            ...
                            >
                              <input
                                ...
                                maxfilesize={5242880}
                              />
                              <span className="uploadFilenewArea flex items-center">
                                {" "}
                                <img
                                  className="upiconimg"
