    ...
    if (inputRef.current.length) {
      ...
      if (files) {
        for (const key of Object.keys(files)) {
          formData.append("dam_files", files[key]);
        }
      }
      formData.append("name", "");
      formData.append("type", 3);
      formData.append("dam_id", collectionid1);
      ...
      indexvalue.current = indexvalue.current + 1;
        ...
        axios
          .post(`${BACKEND_API_URL}agency/dam-media/update_collection/`, formData, {
            headers: {
              "Content-Type": "multipart/form-data",
                ...
                <div className="collectiondataimg sliderleftsec">
                  ...
                  >
                    <div
                      ...
                      onClick={(e) => setIsDisplayDetails(!isDisplayDetails)}
                    >
