...
import Agency_jobList_data from "./Agency-jobList-data";
import Agency_company_data from "./Agency-company-data";
import Agency_wokflow_data from "./Agency-wokflow-data";
import Agency_inviteList_data from "./Agency-inviteList-data";
...
const Agency_data = () => {
  ...
  // const { jobuser, count } = useSelector((state) => state.alljobReducer);
  const { jobuser, In_progress_jobs, Total_Job_count } = useSelector(
    (state) => state.alljobReducer
  );
  ...
  const { agencyadminData, loading: companyLoadings } = useSelector(
  ...
  useEffect(() => {
    dispatch(listAllAgency(agencyId));
  }, []);
          ...
          <div className="inlineprivateProfileContent">
            <div className="privateProfileContent">
              <div className="PhotoprofileDiv">
                <div>
                  {agencyadminData?.profile_img ? (
                    <div className="userprofileimg">
                      <img
                        src={agencyadminData?.profile_img}
            ...
            <div className="feedbackAboutAreaMainD">
              <Box sx={{ width: "100%" }}>
                <TabContext value={value}>
                  ...
                  <TabPanel value="2">{/* <Agency_company_data /> */}</TabPanel>
                  <TabPanel value="3">
                    <Agency_wokflow_data />
                  </TabPanel>
                  <TabPanel value="4">
                    <Agency_inviteList_data />
                  </TabPanel>
                </TabContext>
              </Box>
            </div>
