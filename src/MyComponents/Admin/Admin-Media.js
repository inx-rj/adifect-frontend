                                    ...
                                    {item?.is_video == false && (
                                      <>
                                        <img
                                          ...
                                          onClick={() =>
                                            countimages(item?.id, item?.dam,item?.type)
                                          }
...
{countfav?.includes(item?.dam) && (
                      ...
                      <div className="folder_conttent11">
                        ...
                        {hidefolder &&
                            RootDamData?.length > 0 && yourfilter &&
                            !searchfolder && (
                              <>
                                {" "}
                             ...
                             {hidefolder &&
                            DamCountDataid?.folders?.length > 0 && !yourfilter &&
                            !searchfolder && (
                              <>
                                {" "}
                                <h4 className="files11_contnet">Folders</h4>
                          ...
                          {!hidefolder &&
                            ...
                            !searchfolder && (
                             ...
                             {!hidefolder &&
                            DamParentFilter?.folders?.length > 0 &&  !yourfilter &&
                            !searchfolder && (
                              <>
                                {" "}
                                <h4 className="files11_contnet">Folders</h4>
