...
function Member_All_Collection() {
  ...
  function handleKeyDownSkills(e) {
    ...
    const config = {
      headers: {
        ...
        Authorization: `Bearer ${userDataUser.token}`,
      },
    };
    ...
    <>
      {isLoading ? (
        ...
        <>
          ...
          <div className="input_search22_New_media1 ">
            <input
              onChange={(e) => {
                getvalue1(e);
              }}
              value={searchvalue}
              className="input_search_bar_new_media input_search_bar_new_media1"
              placeholder="Search Files and Folders"
              type="text"
            />
            <i className="fa fa-search iconsec"></i>
          </div>

          <div className="upperclasscoll upperclasscoll-New">
            <div className="upperclass">
              ...
              <div className="media-collection-all-data ">
                <div className="main_slidermidea  mainslider1">
...
export default Member_All_Collection;
