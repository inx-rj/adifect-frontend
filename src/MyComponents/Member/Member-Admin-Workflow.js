...
export default function Member_Admin_Workflow() {
  ...
  // console.log("memberAdmWorkf++++++++++++", memberAdmWorkf);

  useEffect(() => {
    if (headerCompany) {
      dispatch(memberAdminWorkflowAction(headerCompany));
    }
  }, [headerCompany, deleteWorkSuccess]);

  // console.log("iddddddddddddddddddddddddd", headerCompany);
  ...
  }, [memberAdmWorkf, headerCompany, search]);
