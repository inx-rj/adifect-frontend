...
function Member_Admin_company_information(props) {
        ...
        <>
          <div className="allContenOfPrivateAbout">
            <div className="AboutMeTitleDigitalM">
              ...
              <p>{AdminCompanyDetails?.data?.agency_name}</p>
            </div>
            {/* -----------------------------------------email---------------------------------------------             */}
            <div className="AboutMeTitleDigitalM">
              <h3>Email</h3>
              <p>
                {AdminCompanyDetails?.data?.company_email == "null"
                  ? ""
                  : AdminCompanyDetails?.data?.company_email}
              </p>
              {props.showIcon && (
            ...
            <div className="AboutMeTitleDigitalM">
              <h3>Phone</h3>
              <p>
                {AdminCompanyDetails?.data?.company_phone_number == "null"
                  ? ""
                  : AdminCompanyDetails?.data?.company_phone_number}
              </p>
              {props.showIcon && (
                <div className="editIconShowOrHideD">
                  {" "}
            ...
            <div className="AboutMeTitleDigitalM">
              <h3>Website</h3>
              <p>
                {AdminCompanyDetails?.data?.company_website == "null"
                  ? ""
                  : AdminCompanyDetails?.data?.company_website}{" "}
            ...
            <div className="AboutMeTitleDigitalM">
              ...
              <h3>Industry</h3>
              <p>
                {AdminCompanyDetails?.data?.industry_name == "null"
                  ? ""
                  : AdminCompanyDetails?.data?.industry_name}{" "}
              </p>
            </div>
                  ...
                  <div className="dialogcontent_and_actions aboutMeDesFullW">
                    <DialogContent className="profile_title_description">
                      <div>
                        ...
                        <p className="ChangeCurrentEmNamelPop">
                          {AdminCompanyDetails?.data?.company_Language}
                        </p>
                        <div className="NewMailNameAndInput">
                          <div
                            className={
...
export default Member_Admin_company_information;
