...
import Member_Activity from "./Member-activity";
import Member_job_detail_files from "./Member-job-detail-files";
import Member_job_detail_ques_ans from "./Member-job-detail-ques-ans";
import Member_job_details_new_page from "./Member-job-details-new-page";
import { getMemberJobDetailsAction } from "../../redux/actions/activity-member-actions";
...
import { proposalsSeenCount } from "../../redux/actions/proposals-action";
import { useNavigate } from "react-router-dom";
import Creator_Activity from "../Creator/Creator-activity";
import {
  getJobCompletedUsers,
  getJobSubmitStatus,
} from "../../redux/actions/activity-actions";
import Creator_job_detail_ques_ans from "../Creator/Creator-job-detail-ques-ans";
import Creator_job_detail_files from "../Creator/Creator-job-detail-files";
                        ...
                        <TabPanel value="2">
                          {userData?.user?.user_level === 4 ? (
                            ...
                            <Member_Activity
                              ...
                              handleOpenMultipleSubmit={
                                handleOpenMultipleSubmit
                              }
                              handleCloseMultipleSubmit1={
                                handleCloseMultipleSubmit1
                              }
                              handleOpenMultipleSubmit1={
                                handleOpenMultipleSubmit1
                              }
                            />
                          )}
...
export default Member_job_details;
