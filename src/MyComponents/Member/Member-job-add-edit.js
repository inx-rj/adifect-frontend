  ...
  useEffect(() => {
    if (jobId) {
      ...
      if (member_Admin_job_detail_success) {
        ...
        for (let index = 0; index < memberAdminJobDetails.images.length; index++) {
          
          if (memberAdminJobDetails.images[index].work_sample_image_name != null) {
            setissamplefiles(true);
          }
