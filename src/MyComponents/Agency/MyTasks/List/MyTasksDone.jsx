...
const MyTasksDone = (props) => {
  ...
  useEffect(() => {
    if (agencyMyTasksByFilter) {
      let numberPages = Math.ceil(count / 6);
      setPages(numberPages);
    }
  }, [agencyMyTasksByFilter, props.company, props.ordering]);
        ...
        <>
          <div>
            ...
            <div className="Sort_content">
              <h1 className="Analyticstitle_contnet ">Completed Tasks</h1>
            </div>
            <div className="Reviewinproject">
              <div className="Performanceadsapplied ">
                {agencyProjectsByFilterData?.length > 0 ? (
                  ...
                  <div className="NoJobsProjectsPage">No tasks found</div>
                )}
              </div>
            </div>
            {pages > 1 && (
