...
function Agency_projects_done(props) {
  ...
  useEffect(() => {
    if (agencyProjectsByFilter) {
      let numberPages = Math.ceil(count / 6);
      setPages(numberPages);
    }
  }, [agencyProjectsByFilter, props.company, props.ordering]);
                              ...
                              <div className="Work-In_contnet">
                                ...
                                <div className="Marketingcampaign">
                                  ...
                                  <div className="Marketingcampaign2">
                                    ...
                                    <Link
                                      to="#"
                                      className="progresstext_contnet_done"
                                    >
                                      Completed
                                    </Link>
                                    <Link
...
export default Agency_projects_done;
