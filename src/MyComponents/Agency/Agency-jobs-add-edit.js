...
export default function Agency_jobs_add_edit() {
  ...
  useEffect(() => {
    if (headerCompany) {
      ...
      const success = api
        .get(`${BACKEND_API_URL}agency/company/${headerCompany}`)
        .then((res) => {
      ...
      if (headerCompany !== null) {
        dispatch(listAgencyInHouseUsers(headerCompany));

        dispatch(getRelatedJobs(headerCompany));
        setShow(true);
        console.log("Header company changed");
        const success = api
          .get(`${BACKEND_API_URL}agency/works-flow/?company=${headerCompany}`)
          .then((res) => {
            setapivalue(res?.data?.data?.results || res?.data?.data);
          });
        const successTemplateApi = api
          .get(`${BACKEND_API_URL}job-template/?company=${headerCompany}`)
          .then((res) => {
            // gettemplate(e);
  ...
  const threeDay = new Date(new Date().setDate(new Date().getDate() + 4));

  const coverter1 = moment(threeDay).format("MM-DD-YYYY");

  const sevenDay = new Date(new Date().setDate(new Date().getDate() + 8));
  ...
  useEffect(() => {
    if (jobId) {
      ...
      if (success) {
        ...
        setDeliveryDate(new Date(jobDetails.expected_delivery_date));
  ...
  console.log(["Text Copy"].includes(jobDetailsTitle(Number(location.state?.['selectedJobType'] ?? jobDetails?.create_job_type))));
          ...
          <div className="ContentDiv jobaddformtop" onClick={removeSkillPopup}>
            <div className="Describe half-form-validation ">
              <div className="formjobsagencyadd">
                ...
                >
                  ...
                  <div className="styled-select Companyname Companyname_1">
                    <Select
                      className={
                        companyvalue === null
                          ? "selectinputcolor selectinputcoloraddon"
                          : "menuiteminputcolor"
                      }
                      open={isOpen9}
                      onOpen={() => {
                    ...
                    >
                      ...
                      {companyData?.map((item, i) =>
                        item.is_active ? (
                          <MenuItem
                            key={item.id}
                            className={`newaddcompany-${item.id}`}
                            value={item.id}
                          >
                            {item?.name}
                          </MenuItem>
                ...
                {show ? (
                  <>
                    ...
                    >
                      ...
                      <div className="styled-select Companyname Companynameapprover">
                        <Select
                          className={
                            Workflowdata === null
                              ? "selectinputcolor selectinputcolorapprover"
                              : "menuiteminputcolor"
                          }
                          open={isOpen8}
                          onOpen={() => {
                        ...
                        >
                          ...
                          {apivalue?.map((item) =>
                            item.is_active ? (
                              <MenuItem
                                key={item.id}
                                className={`newaddworkflow-${item.id}`}
                                value={item.id}
                              >
                                {item?.name}
                              </MenuItem>
                      ...
                      <div className="styled-select Companyname">
                        ...
                        >
                          ...
                          {templatevalue?.map((item) => (
                            <MenuItem
                              key={item.id}
                              className={`newaddtemplate-${item.id}`}
                              value={item.id}
                            >
                              {item?.template_name}
                            </MenuItem>
                        ...
                        >
                          ...
                          {industryvalue?.map((item) =>
                            item.is_active ? (
                              <MenuItem
                                key={item.id}
                                className={`newaddindustry-${item.id}`}
                                value={item.id}
                              >
                                {item?.industry_name}
                              </MenuItem>
                          ...
                          ?.map(
                            (item) =>
                              item && (
                                <MenuItem
                                  key={item.id}
                                  className={`newaddrelatedjob-${item.id}`}
                                  value={item.id}
                                >
                                  {item.title}
                                </MenuItem>
                ...
                >
                  ...
                  <div className="Marketing- mt-2-">
                    <div className="skills-input-container insidedivautocomplete">
                      ...
                      <Autocomplete
                        ...
                        options={
                          skillsData?.length > 0
                            ? skillsData?.filter((item) => item.is_active)
                            : []
                        }
                    ...
                    <div className="formjobsagencyadd">
                      ...
                      <div className="switch_Agency">
                        <div className="Observers_agency_job_add Observers_agency_job_add1 Observers_agency_job_add2">
                          <label className="switch fileasset" id="switchone">
                            {isfiles && (
                              <>
                                {" "}
                                <input
                        ...
                        <div className="formjobsagencyadd">
                          <div className="switch_Agency">
                            <div className="Observers_agency_job_add  Observers_agency3 ">
                              <label className="switch sampleassets">
                                {issamplefiles && (
                                  <>
                                    {" "}
                                    <input
                ...
                <div className="text-content Skills Experiencenew_2">
                  ...
                  <div className="switch_Agency">
                    <div className="Observers_agency_job_add">
                      <label className="switch taskswitch">
                        {isShowntask && (
                          <input
                            type="checkbox"
                            checked={true}
              ...
              <div className="formjobsagencyadd">
                <div className="text-content ">
                  ...
                  <div className="switch_Agency">
                    <div className="Observers1">
                      <label className="switch budgetswitchcase">
                        <input
                          type="checkbox"
                ...
                {!isBudgetNotRequired && (
                  <>
                    <div
                      className={
                        errors.level
                          ? "text-content error Experiencenew selectinputexDiv"
                          : "text-content  Experiencenew selectinputexDiv"
                      }
                    >
                      ...
                      <div className="styled-select Companyname selectinputex">
                        <Select
                          className={
                            level === null
                              ? "selectinputcolor selectinputexp"
                              : "menuiteminputcolor"
                          }
                          open={isOpen10}
                          onOpen={() => {
                          ...
                          {levelsData?.length &&
                            levelsData?.map((item) =>
                              item.is_active ? (
                                <MenuItem
                                  key={item.id}
                                  className={`newaddlevels-${item.id}`}
                                  value={item.id}
                                >
                                  {item.level_name}
                                </MenuItem>
                ...
                <div className="text-content my-2">
                  {!isBudgetNotRequired && (
                    <>
                      ...
                      <div className="diverrors44 diverrors44Space priceValidationMessage">
                        <span
                          style={{
                            color: "#D14F4F",
                ...
                <div className="switch_Agency">
                  <div className="Observers1">
                    <label className="switch templatecase">
