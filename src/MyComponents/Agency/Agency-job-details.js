...
import Agency_Activity from "./Agency-activity";
import Agency_job_detail_files from "./Agency-job-detail-files";
import Agency_job_detail_proposal from "./Agency-job-detail-proposal";
import Agency_job_detail_ques_ans from "./Agency-job-detail-ques-ans";
import Agency_job_details_new_page from "./Agency-job-details-new-page";
...
import { getJobDetailsAgency } from "../../redux/actions/job-actions";
                  ...
                  <div className="Activitysec agencyjobdetailspage">
                    <Box sx={{ width: "100%" }}>
                      <TabContext value={value}>
                        ...
                        <TabPanel value="3">
                          <Agency_job_detail_files />
                        </TabPanel>
                        <TabPanel value="4">
                          <Agency_job_detail_proposal
                            jobProposalDate={jobDetails.expected_delivery_date}
                            jobProposalPrice={jobDetails.price}
                            handleChangeTab={handleChange}
                            statusJob={jobDetails.is_active}
                          />
                        </TabPanel>
                        <TabPanel value="5">
                          <Agency_job_detail_ques_ans />
                        </TabPanel>
                      </TabContext>
                    </Box>
                  </div>
...
export default Agency_job_details;
