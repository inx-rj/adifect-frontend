...
export class CommentStore {
  ...
  constructor(editor: LexicalEditor, commentCacheStore) {
    this._comments = commentCacheStore;
    this._editor = editor;
  ...
  addComment(
    ...
    if (thread !== undefined && commentOrThread.type === "comment") {
      ...
      //   this._withRemoteTransaction(() => {
      //     const sharedMap = this._createCollabSharedMap(commentOrThread);
      //     sharedsCommentsArray.insert(insertOffset, [sharedMap]);
      //   });
      // }
...
export function useCommentStore(commentStore : CommentStore) {
