        ...
        <div className="header">
          {/* <div className="logo">
            <Link to="/home">
              <img
                className="logoimg"
                src={import.meta.env['VITE_PUBLIC_URL'] + "/img/logonew.svg"}
                alt=""
              />
            </Link>
            <button
          ...
          <div className="loginRight">
            ...
            >
              <Link to="#">
                {/* <img src={import.meta.env['VITE_PUBLIC_URL'] + "/img/icon.png"} alt="" /> */}
                <img
                  src={import.meta.env['VITE_PUBLIC_URL'] + "/img/Company-Vector.png"}
                  alt=""
                />
              </Link>
            ...
            {/* <li className="ml-7 icon2">
              <Link to="#">
                <img
                  src={import.meta.env['VITE_PUBLIC_URL'] + "/img/Emailicon.png"}
                  alt=""
                />
              </Link>
            </li> */}
            <li className="ml-7 nots">
              <Link className="vector" to="#">
                <img src={import.meta.env['VITE_PUBLIC_URL'] + "/img/Vector.png"} alt="" />
              </Link>
            </li>
            <li
            ...
            >
              <Link className="LoginName dropdown" to="#">
                <span className="header-profile-pic">
                  ...
                  {!user?.profile_img && (
                    <img
                      src={import.meta.env['VITE_PUBLIC_URL'] + "/img/avataruser.png"}
                      alt=""
                    />
                  )}
                  {/* <img
                    src={import.meta.env['VITE_PUBLIC_URL'] + "/img/loginimg.png"}
                    alt=""
                  /> */}
                </span>
                  ...
                  <div className="loginsigin">
                    <li>
                      <Link to="/profile">
                        <img
                          ...
                          src={import.meta.env['VITE_PUBLIC_URL'] + "/img/profile.png"}
                          alt=""
                        />
                        Profile
                      </Link>
                      ...
                      <>
                        <li>
                          <Link to="/invite">
                            <img
                              className="mr-2 logout"
                              src={import.meta.env['VITE_PUBLIC_URL'] + "/img/Projects.png"}
                              alt=""
                            />
                            Invite
                          </Link>
                    ...
                    <li onClick={logoutHandler}>
                      <Link to="/">
                        <img
                          className="mr-2 logout"
                          src={import.meta.env['VITE_PUBLIC_URL'] + "/img/logout.png"}
                          alt=""
                        />
                        Logout
                      </Link>
