        ...
        <Router>
          <Routes>
            ...
            >
              ...
              {/* <Route
                exact
                path="/member-company/add/:jobId_Jobid"
                element={
                  <ProtectedRoute>
                    <AdminMember_Company_add />
                  </ProtectedRoute>
                }
              ></Route> */}
              ...
              {/* <Route
                exact
                path="/member-company/edit/:companyId"
                element={
                  <ProtectedRoute>
                    <AdminMember_Company_add />
                  </ProtectedRoute>
              ...
              <Route
                exact
                path="/intake_forms/userResponse/:userID"
                element={
            ...
            <Route
              exact
              path="/intake_forms/:formID/:versionNum"
              element={
                <PublicRoute>
                  <ShareFormWrapper />
                </PublicRoute>
